...
@Dong2006 follow the same basic classification approach as Handy and Neimeier, 
illustrating mathematically how the three different types of measures can be
collapsed into each other.
@GEURS2004127 group cumulative opportunity and gravity-based measures into
...
access across cities [@Rigolon2018]. ParkScore may be less useful at identifying the
...
trips based on discrete-choice regression models. @mcfadden1974measurement 
...
destinations [@de2011modelling]. Though the application of random utility models
to destination choice is not new [see @anas1983discrete], the increasing
...
@macfarlaneNYC applied the @Kinnell2006 estimates in an exploration of
...
recreation and social trips together [@nchrp716]. However, the advent of large-scale
...
[@Naboulsi2016]. Such passively collected location data --- sometimes referred
to as “Big Data” --- is a by-product of other systems including cellular call
data records  [e.g., @Bolla2000;
...
@Bernardin2018 employs a passive origin-destination matrix as a shadow price
...
predictions. 
@tf_idea use the passive flow data 
as a probabilistic sampling frame to recreate individual trips through simulation
A similar method developed by @Zhu2018 uses the passive dataset
...
sample of a small population (taxi passengers). The @Zhu2018 methodology could
