...
shifted more recently towards activity-based models that distribute trips based
on discrete-choice regression models. @mcfadden1974measurement first applied
