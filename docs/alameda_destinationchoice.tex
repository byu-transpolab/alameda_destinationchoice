...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={City parks and slow streets: a utility-based access and equity analysis},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  %
   ...
   \ead{teresa.tapia@streetlightdata.com} 
      \affiliation[BYU]{Brigham Young University, Civil and Environmental Engineering Department, 430 Engineering Building, Provo, Utah 84602}
    \affiliation[Harvard]{Harvard Graduate School of Design, 48 Quincy St, Cambridge, Massachussetts 02138}
    \affiliation[StreetLight]{StreetLight Data, Inc., San Francisco, California}
...
\midrule
\cellcolor{gray!6}{log(Distance)} & \cellcolor{gray!6}{\num{-1.267} ***} & \cellcolor{gray!6}{\num{-1.496} ***} & \cellcolor{gray!6}{\num{-1.272} ***} & \cellcolor{gray!6}{\num{-1.476} ***} & \cellcolor{gray!6}{\num{-1.389} ***} & \cellcolor{gray!6}{\num{-1.393} ***} & \cellcolor{gray!6}{\num{-1.345} ***} & \cellcolor{gray!6}{\num{-1.273} ***} & \cellcolor{gray!6}{\num{-1.521} ***} & \cellcolor{gray!6}{\num{-1.379} ***}\\
 & (\num{0.017}) & (\num{0.031}) & (\num{0.022}) & (\num{0.019}) & (\num{0.027}) & (\num{0.020}) & (\num{0.013}) & (\num{0.029}) & (\num{0.037}) & (\num{0.011})\\
\cellcolor{gray!6}{log(Acres)} & \cellcolor{gray!6}{\num{0.384} ***} & \cellcolor{gray!6}{\num{0.288} ***} & \cellcolor{gray!6}{\num{0.352} ***} & \cellcolor{gray!6}{\num{0.365} ***} & \cellcolor{gray!6}{\num{0.331} ***} & \cellcolor{gray!6}{\num{0.384} ***} & \cellcolor{gray!6}{\num{0.352} ***} & \cellcolor{gray!6}{\num{0.358} ***} & \cellcolor{gray!6}{\num{0.379} ***} & \cellcolor{gray!6}{\num{0.356} ***}\\
 & (\num{0.009}) & (\num{0.016}) & (\num{0.012}) & (\num{0.010}) & (\num{0.014}) & (\num{0.011}) & (\num{0.007}) & (\num{0.015}) & (\num{0.020}) & (\num{0.006})\\
\cellcolor{gray!6}{Playground} & \cellcolor{gray!6}{\num{-0.482} ***} & \cellcolor{gray!6}{\num{-0.670} ***} & \cellcolor{gray!6}{\num{-0.353} ***} & \cellcolor{gray!6}{\num{-0.825} ***} & \cellcolor{gray!6}{\num{-0.630} ***} & \cellcolor{gray!6}{\num{-0.647} ***} & \cellcolor{gray!6}{\num{-0.554} ***} & \cellcolor{gray!6}{\num{-0.366} ***} & \cellcolor{gray!6}{\num{-0.699} ***} & \cellcolor{gray!6}{\num{-0.615} ***}\\
 & (\num{0.038}) & (\num{0.062}) & (\num{0.048}) & (\num{0.043}) & (\num{0.057}) & (\num{0.046}) & (\num{0.029}) & (\num{0.062}) & (\num{0.080}) & (\num{0.026})\\
...
\midrule
Households with Children under 6 & \$137,832 & 14.19 & 83,868 & 14.53\\
