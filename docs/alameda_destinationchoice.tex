...
homes, periodic use of public space provided an opportunity physical and
...
constructed individuals living in U.S. Census block groups of varying
sociodemographic characteristics value the travel distance between block group
...
approach taken to apply the results to analyze open streets projects. A
...
majorityof residents in dense areas like San Francisco (100\%) and New York City
...
\emph{utility}, of each alternative. Utility may be function of distance or travel
...
highly-utilized than another. For a utility-based measure of park accessibility,
...
referred to part of a larger category of ``Big Data'' --- is a by-product of other
...
modeled predictions. \citet{tf_idea} use the passive flow data as a probabilistic
...
or short-term parking to for urban freight or food delivery.
...
using the \texttt{networkx} package for Python \citep{networkx},
...
model \citep[\citet{Recker1978}]{McFadden1974},
...
weighted by the volume of the flows. This corresponds to a 4.3\% sample of all the observed device origin-destination pairs.
...
difficult to estimate choice models with so many alternatives (\(|J| = `r nrow(parks)`\)). For this reason we randomly sample 10 additional parks
...
sports. As described in the \protect\hyperlink{results}{Results} section, the ``Sport Detail''
...
conversion --- we may apply a destination choice model to calculate the change in
...
AIC & 58368.6 & 56793.5 & 56648.5\\
Log.Lik. & -29182.289 & -28391.737 & -28314.271\\
rho2 &  &  & \\
rho20 & 0.392 & 0.408 & 0.410\\
\bottomrule
...
definitions largely informed by the distributions in \ref{tab:acs-table}.
...
\midrule
\cellcolor{gray!6}{log(Distance)} & \cellcolor{gray!6}{-1.295***} & \cellcolor{gray!6}{-1.566***} & \cellcolor{gray!6}{-1.355***} & \cellcolor{gray!6}{-1.475***} & \cellcolor{gray!6}{-1.459***} & \cellcolor{gray!6}{-1.355***} & \cellcolor{gray!6}{-1.410***} & \cellcolor{gray!6}{-1.408***} & \cellcolor{gray!6}{-1.504***} & \cellcolor{gray!6}{-1.406***}\\
 & (0.017) & (0.031) & (0.023) & (0.018) & (0.025) & (0.021) & (0.013) & (0.028) & (0.036) & (0.012)\\
\cellcolor{gray!6}{log(Acres)} & \cellcolor{gray!6}{0.386***} & \cellcolor{gray!6}{0.271***} & \cellcolor{gray!6}{0.325***} & \cellcolor{gray!6}{0.348***} & \cellcolor{gray!6}{0.308***} & \cellcolor{gray!6}{0.388***} & \cellcolor{gray!6}{0.341***} & \cellcolor{gray!6}{0.310***} & \cellcolor{gray!6}{0.410***} & \cellcolor{gray!6}{0.347***}\\
 & (0.009) & (0.016) & (0.011) & (0.010) & (0.013) & (0.011) & (0.007) & (0.014) & (0.020) & (0.006)\\
\cellcolor{gray!6}{Playground} & \cellcolor{gray!6}{-0.460***} & \cellcolor{gray!6}{-0.598***} & \cellcolor{gray!6}{-0.283***} & \cellcolor{gray!6}{-0.808***} & \cellcolor{gray!6}{-0.572***} & \cellcolor{gray!6}{-0.588***} & \cellcolor{gray!6}{-0.530***} & \cellcolor{gray!6}{-0.490***} & \cellcolor{gray!6}{-0.821***} & \cellcolor{gray!6}{-0.533***}\\
 & (0.039) & (0.060) & (0.046) & (0.041) & (0.050) & (0.049) & (0.029) & (0.059) & (0.079) & (0.025)\\
\cellcolor{gray!6}{Trail} & \cellcolor{gray!6}{0.509***} & \cellcolor{gray!6}{0.485***} & \cellcolor{gray!6}{0.380***} & \cellcolor{gray!6}{0.868***} & \cellcolor{gray!6}{0.504***} & \cellcolor{gray!6}{0.686***} & \cellcolor{gray!6}{0.567***} & \cellcolor{gray!6}{0.364***} & \cellcolor{gray!6}{0.685***} & \cellcolor{gray!6}{0.581***}\\
...
AIC & 19300.7 & 7407.2 & 12597.8 & 16843.6 & 10423.8 & 12112.5 & 33870.9 & 8198.8 & 4562.8 & 43838.4\\
\cellcolor{gray!6}{Log.Lik.} & \cellcolor{gray!6}{-9640.326} & \cellcolor{gray!6}{-3693.609} & \cellcolor{gray!6}{-6288.879} & \cellcolor{gray!6}{-8411.797} & \cellcolor{gray!6}{-5201.882} & \cellcolor{gray!6}{-6046.232} & \cellcolor{gray!6}{-16925.433} & \cellcolor{gray!6}{-4089.399} & \cellcolor{gray!6}{-2271.383} & \cellcolor{gray!6}{-21909.192}\\
rho2 &  &  &  &  &  &  &  &  &  & \\
\cellcolor{gray!6}{rho20} & \cellcolor{gray!6}{0.390} & \cellcolor{gray!6}{0.395} & \cellcolor{gray!6}{0.334} & \cellcolor{gray!6}{0.494} & \cellcolor{gray!6}{0.376} & \cellcolor{gray!6}{0.479} & \cellcolor{gray!6}{0.396} & \cellcolor{gray!6}{0.369} & \cellcolor{gray!6}{0.459} & \cellcolor{gray!6}{0.412}\\
\bottomrule
...
inconsistency: for instance, block groups with at least 40\% of low income
households show a lower importance of distance than block groups with either 30\%
low income households. The increasing width of the confidence interval, however,
means it is sometimes difficult to make generalized statements. Residents of
...
\begin{figure}
\centering
\includegraphics{alameda_destinationchoice_files/figure-latex/split-plots-orig-1.pdf}
\caption{\label{fig:split-plots-orig}Estimated utility coefficients and 95\% confidence intervals for park amenities at different socioeconomic threshold levels.}
\end{figure}
...
non-segmented model from Table \ref{tab:base-modelsummary}.
...
household level and other (ethnicity) are defined at the person level. It is
...
\midrule
Households with Children under 6 & \$94,911 & 14.28 & 85,316 & 14.89\\
Income < \$35k & \$148,998 & 22.42 & 95,683 & 16.70\\
Income > \$125k & \$194,052 & 29.20 & 211,540 & 36.93\\
Black & \$120,544 & 18.14 & 62,205 & 10.86\\
Asian & \$127,771 & 19.22 & 162,378 & 28.34\\
\addlinespace
Hispanic & \$147,766 & 22.23 & 118,620 & 20.71\\
White & \$227,161 & 34.18 & 195,626 & 34.15\\
All Households & \$664,628 & 100.00 & 572,870 & 100.00\\
\bottomrule
...
better understand the nunces and tradeoffs inherent in a wide range of policy
proposals.
