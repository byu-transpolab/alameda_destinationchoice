...
modes? Or do they choose destinations first, and then choose the best mode to get there?
...
$\cdots$
\DIFaddbegin \DIFadd{ Using the mode choice logsum  would also  enable the inclusion of qualitative path attributes (sidewalk quality, greenery, etc.) known to  influence experienced travel impedance for particular modes of travel \citep{clifton2016}.} \DIFaddend
\end{quote}
