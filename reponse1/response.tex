...
distribution has not been affected. 
...
\AR We feel the previous addition has also addressed this caveat, which we agree
...
meaningful difference between the two measures.  To do as the reviewer suggests
...
\AR It is possible that the reviewer has misunderstood our methodology. We
...
\AR We agree that our positioning of the equity analysis and its relationship to accessibility
would benefit from a firmer grounding in the literature. We are grateful for the 
references the reviewer provided, which have allowed us to strengthen these 
...
pro-social manner }\DIFdelend \DIFaddbegin \DIFadd{manner in the sense that the distributin favored marginalized populations}\DIFaddend .
\end{quote}
