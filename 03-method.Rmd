...
names(acs_for_table)[8] <- paste0(kableExtra::footnote_marker_symbol(1), 
...
datasummary_skim(acs_for_table, title = "Block Group Summary Statistics",
  ...
  kableExtra::column_spec(1, width = "4cm", latex_column_spec = "{>{\hangindent=.2in}L}") %>%
  kableExtra::add_footnote("Hispanic indicates Hispanic individuals of all races; non-Hispanic individuals report a single race alone.") %>%
...
in monetary terms [@Handy1997;@Dong2006].
