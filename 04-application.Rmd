...
transformation [@Yeo2000] to both distance the distance (in meters) between the
...
```{r split-plots-knit, fig.cap="Estimated utility coefficients and 95% confidence intervals for park amenities at different socioeconomic threshold levels.", fig.height=7.5}

knitr::include_graphics("images/split_plot.png")

```

```{r split-plots-orig, fig.cap="Estimated utility coefficients and 95% confidence intervals for park amenities at different socioeconomic threshold levels.", fig.height=7.5, cache = FALSE}
