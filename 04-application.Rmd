...
reports that `r nrow(street_parks)` individual streets were converted; these streets represent 
...
As shown with Equation \@ref(eq:deltalogsum), the difference in utility-based
...
destination choices for non-work trips.^[To be precise, this is the cost
