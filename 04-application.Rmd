...
to `r d_ratio_sport`. Examining the two amenities models --- independently and in 
...
and Park Attributes model has $p$-value  `r detail_lrt`), and so in spite of the
...
thirty percent Black persons are included in the ">30% Black" model, an
analogous segmentation for block groups with high Asian and Hispanic populations
are in the ">30% Asian" and ">30% Hispanic" models respectively, and the "Other"
...
modelsummary(
  ...
  add_header_above(c(" " = 1, "Minority" = 4, "Income" = 3, "Children" = 3)) %>%
  scroll_box(width = "100%", box_css = "border: 0px;") %>%
  landscape() %>%
